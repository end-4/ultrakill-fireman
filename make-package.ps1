...
$modFolder = $root
$assemblyPath = Join-Path $modFolder "Fireman/bin/$Configuration/netstandard2.1/$assemblyName"
$docPath = Join-Path $modFolder "Fireman/bin/$Configuration/netstandard2.1/$docName"
